...
enum iformats { I_AUTO=0, I_PBM=1, I_FAX=2, I_TEXT=3, I_TIFF=4, I_DFAX=5, I_PCX=6, I_RAW=7, I_DCX=8 };

#define IFORMATS { "AUTO", "PBM", "FAX", "TEXT", "TIFF", "DFAX", "PCX", "RAW", "DCX" };
//Here comes the trouble maker
enum oformats { O_AUTO=0, O_PBM=1, O_FAX=2, O_PCL=3, O_PS=4, O_PGM=5, O_TIFF_FAX=7, O_TIFF_RAW=8, O_DFAX=9, O_TIFF=10, O_PCX=11, O_PCX_RAW=12, O_DCX=13 } ; // this caused trouble " O_TEXT=6, "
//This was the trouble maker
#define OFORMATS { "AUTO", "PBM", "FAX", "PCL", "PS", "PGM", "TEXT", "TIFF", "TIFF", "DFAX", "TIFF", "PCX", "PCX", "DCX" } 
